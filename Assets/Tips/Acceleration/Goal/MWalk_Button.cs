...
public class MWalk_Button : MonoBehaviour
{
...

    {
        ...
        okButton = GameObject.Find("Canvas/Mwalk_Button");
        script = okButton.GetComponent<OKButton>();

        weightGO = GameObject.Find("Canvas/MokuhyoWalk");
        weightScript = weightGO.GetComponent<MokuhyoWalk>();
    ...
    public void _saveData(int weight)
    {
        ...
        _list.FindAsync((List<NCMBObject> objList, NCMBException e) =>
        {
            if (e == null)
            {
                ...
                {
                    objList[0]["mokuhyoWalk"] = weightValue;
                    objList[0].SaveAsync();
                }
